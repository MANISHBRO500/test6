...
app.post('https://manishbro500.github.io/test6/public/teacher.html/add-question', async (req, res) => {
...
app.get('https://manishbro500.github.io/test6/public/student.html/questions', async (req, res) => {
  const questions = await Question.find();
  res.json(questions);
});

// Submit student answers
app.post('https://manishbro500.github.io/test6/public/student.html/submit-answers', async (req, res) => {
...
app.delete('https://manishbro500.github.io/test6/public/teacher.html/delete-question/:id', async (req, res) => {
  try {
